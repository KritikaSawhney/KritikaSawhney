...
👯 I’m looking to collaborate on Open Source, AI, and Hackathon projects  
...
🥇 **Google Hackathon Winner** — HackWithIndia at Google, Gurugram  
Competed among **25,000+ participants** and reached the **Top 10 Finalists**, presenting an AI-powered crypto trading bot to the Google judge panel.

🏆 **Winner — HackWithHer 4.0 (Diversity Prize)**  
Built **SakhiJunction**, a women-focused self-care & community platform and secured **Second Runner-Up** position while winning the **Diversity Prize**.

🧠 **Competitive Programming & DSA**  
Solved problems across **LeetCode, Codeforces & GeeksforGeeks** and achieved **Codeforces Specialist (Max Rating: 1450)**.

🌍 **SheCodes Scholar 2024** — Selected for a global coding scholarship empowering women in tech  
